 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://p2/", wsdlLocation = "http://localhost:8080/WebApplication1/Calculator?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://p2/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebApplication1/Calculator?WSDL");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://p2/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://p2/", "CalculatorPort"), Calculator.class, features);
    }
